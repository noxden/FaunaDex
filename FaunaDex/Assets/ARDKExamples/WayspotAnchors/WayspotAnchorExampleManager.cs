...
namespace Niantic.ARDKExamples.WayspotAnchors
{
    public class WayspotAnchorExampleManager : MonoBehaviour
    {
        ...
        [Tooltip("Text used to show the current localization failure reason")]
        [SerializeField]
        private Text _localizationFailureReason;
        ...
        private void OnLocalizationStateUpdated(LocalizationStateUpdatedArgs args)
        {
            ...
            _localizationFailureReason.text = args.FailureReason.ToString();
        }
