...
public class DexEntryHandlerOtto : MonoBehaviour
{
    [SerializeField] private List<Sprite> DexImages;

    private int Index { get; set; } = 0;
    private GameObject MapArea => GameObject.Find("MapAreaOtto");
    private Image DexImage => GameObject.Find("DexImagesOtto").GetComponent<Image>();
